...
<main>
  ...
  <?php if(session('err')): ?> <div class="alert"><?php echo e(session('err')); ?></div> <?php endif; ?>
  ...
  <article>
    ...
    <form method="POST" action="<?php echo e(route('login.post')); ?>">
      ...
      <input type="text" id="username" name="username" value="<?php echo e(old('username')); ?>" placeholder="username" required autofocus>
  ...
  <p class="note">© <?php echo e(date('Y')); ?> Web Forum Diskusi</p>
</main>
...
<?php /**PATH C:\Users\ASUS\nemosoc\resources\views/auth/login.blade.php ENDPATH**/ ?>